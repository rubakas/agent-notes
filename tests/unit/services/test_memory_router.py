"""Tests for agent_notes.memory.memory_router dispatch functions."""
import pytest
...
class TestMemoryInit:
    ...
    def test_obsidian_backend_calls_obsidian_init(self, tmp_path):
        from agent_notes.memory.memory_router import memory_init
        with patch("agent_notes.memory.obsidian_backend.obsidian_init") as mock_fn:
    ...
    def test_local_backend_calls_local_init(self, tmp_path):
        from agent_notes.memory.memory_router import memory_init
        with patch("agent_notes.memory.local_backend.local_init") as mock_fn:
...
class TestMemoryRegenerateIndex:
    ...
    def test_obsidian_backend_calls_obsidian_regenerate_index(self, tmp_path):
        from agent_notes.memory.memory_router import memory_regenerate_index
        with patch("agent_notes.memory.obsidian_backend.obsidian_regenerate_index") as mock_fn:
            memory_regenerate_index("obsidian", tmp_path)
        mock_fn.assert_called_once_with(tmp_path)

    def test_local_backend_calls_local_regenerate_index(self, tmp_path):
        from agent_notes.memory.memory_router import memory_regenerate_index
        with patch("agent_notes.memory.local_backend.local_regenerate_index") as mock_fn:
