...
description: "Rails models advanced: transactions, enums, normalization, serialization, storage, and common patterns. Use when user needs enums, transactions, serialized attributes, or complex model patterns."
group: rails
---
